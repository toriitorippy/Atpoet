...
struct MasterPoeruPlaceView: View {
    ...
    var body: some View {
        VStack{
            ...
            ZStack{
                MasterPoeruPlaceMapView(manager: $poeru_manager, alert: $alert, hasPin: $hasPin, latitude: $latitude, longitude: $longitude)
...
struct MasterPoeruPlaceView_Previews: PreviewProvider {
    static var previews: some View {
        MasterPoeruPlaceView(presentedDraft: .constant(DraftDataItem(title: "Test", body_text: "Testをすることはとても大事だと思います。なぜならば人間の認知機能には限界があり、Testなしでは正確な判断ができないからです。", image: nil, latitude: 0, longitude: 0, tag: "#大事なこと#忘れるな", placeName: "@柏ハウス")))
    }
}
